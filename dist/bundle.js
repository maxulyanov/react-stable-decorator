...
var _ErrorComponent = __webpack_require__(37);
 ...
 * @returns {ReactStable}
 */
function reactStableDecorator(Component) {
  var printConsole = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
  var CustomErrorComponent = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : _ErrorComponent2.default;


  return function (_React$Component) {
    _inherits(ReactStable, _React$Component);

    /**
     *
     * @param props
     */
    function ReactStable(props) {
      _classCallCheck(this, ReactStable);

      return _possibleConstructorReturn(this, (ReactStable.__proto__ || Object.getPrototypeOf(ReactStable)).call(this, props));
    }
    ...
    _createClass(ReactStable, [{
      ...
      key: '_callWrapper',
      value: function _callWrapper(methodName, args) {
        try {
          return this._hasMethod(methodName) && this.component[methodName](args);
        } catch (error) {
          printConsole && console.error(error.message);
          return CustomErrorComponent ? _react2.default.createElement(CustomErrorComponent, { error: error }) : null;
        }
      }
      ...
      key: '_hasMethod',
      value: function _hasMethod(methodName) {
  ...
  _createClass(ErrorComponent, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { style: style, className: 'error-message' },
